...
jQuery(function($) {
    ...
    $(document).ready( function() {
        ...
        console.log('tautan', location.search);

        if(location.search == '?tautan'){
            console.log('masuk tautan');
            $('#menu-section').removeClass('active').addClass('inactive');
            $('#tautan-section').removeClass('inactive').addClass('active');
        }
    });
